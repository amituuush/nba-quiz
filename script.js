...
function displayQuizQuestion() {
	...
	if (quiz.currentQuestion < 5) {
		...
		// checks user answer and adds 1 to var numberOfCorrectAnswers if correct
		...
		// appends number of correct answers on score page
		$(".score-page span").html(numberOfCorrectAnswers);
